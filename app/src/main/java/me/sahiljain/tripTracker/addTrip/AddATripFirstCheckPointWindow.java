 ...
 */
public class AddATripFirstCheckPointWindow extends AppCompatActivity implements GoogleMap.OnMapClickListener {
    ...
    protected void onResume() {
        ...
        boolean flag = true;
        View view = findViewById(R.id.map_add_a_trip_first_cp);
        if (view != null) {
            flag = false;
        }
        ...
        if (flag) {
            try {
                setContentView(R.layout.add_a_trip_first_checkpoint);
                setUpMapIfNeeded();
            } catch (Exception e) {
        ...
        final Button previousButton = (Button) findViewById(R.id.previous_button_add_a_trip_first_cp);
        ...
        Button nextButton = (Button) findViewById(R.id.next_button_add_a_trip_first_cp);
        ...
        new AlertDialog.Builder(this).setTitle(Constants.ENTER_LOCATION_NAME)
                ...
                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ((App) getApplicationContext()).getTrip().setCheckPoint1Name(input.getText().
                                toString());
                        startActivity(intentAddATripSecondCheckpointWindow);
    ...
    private void setUpMapIfNeeded() {
        ...
        if (mMap == null) {
            ...
            mMap = ((SupportMapFragment) getSupportFragmentManager().
                    findFragmentById(R.id.map_add_a_trip_first_cp))
                    .getMap();
...
//                setButtonPosition();
    ...
    public void onMapClick(LatLng latLng) {
        ...
        saveCheckPoint1Coordinates(latLng);
    ...
    private void saveCheckPoint1Coordinates(LatLng latLng) {
        trip = ((App) getApplication()).getTrip();
        if (trip != null) {
            trip.setLatCheckPoint1((float) latLng.latitude);
            trip.setLongCheckPoint1((float) latLng.longitude);
        }
